(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var appStyle = {"question-footer":"app_question-footer__pp4lS","question-modal":"app_question-modal__Ujvf6","centered":"app_centered__tlxCj","success":"app_success__OvDRI"};
    ...
    function Actions() {
        ...
        var showBackButton = !isFirstQuestion && !isSubmitted;
    ...
    */
    ...
    var CheckBox = ReactDOM.forwardRef(function (_a, ref) {
        var label = _a.label, showLabel = _a.showLabel, checked = _a.checked, error = _a.error, className = _a.className, props = __rest$2(_a, ["label", "showLabel", "checked", "error", "className"]);
        var otherProps = {};
        var id = _(function () { return "checkbox-".concat(genID()); }, []);
        if (!showLabel && label) {
            otherProps['aria-label'] = label;
        }
        return (ReactDOM.createElement("div", { className: "".concat(styles$4['checkbox-container'], " ").concat(checked ? styles$4['checkbox-checked'] : '', " ").concat(error ? styles$4['checkbox-error'] : '', " ").concat(className || '') },
    ...
    function SelectOption(_a) {
        ...
        return (ReactDOM.createElement("button", __assign$4({}, otherProps, { className: "".concat(className, " ").concat(multiple ? styles$2['option-multiple'] : ''), type: "button" }),
            multiple && (ReactDOM.createElement("span", { className: "".concat(styles$2['option-checkbox'], " ").concat(selected ? styles$2['option-checkbox-selected'] : '') },
                ReactDOM.createElement(CheckBox, { checked: selected, className: styles$2['select-multiple-checker'] }))),
